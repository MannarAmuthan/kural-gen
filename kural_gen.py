...
english_embedding = KeyedVectors.load('models/english_embedding.kvmodel')
kural_vocab_embedding = KeyedVectors.load('models/kural_vocab_embedding.kvmodel')
...
print(" ".join(generated[0:4]))
print(" ".join(generated[4:]))
